...
from EasyPytorch.Model import NetWork, loss, metric
from EasyPytorch.Vsualization import TensorBoard, Logger
...
class BaseTrainer:
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        """
        if not glob(join(resume_path, self.config.suffix)):
            return
